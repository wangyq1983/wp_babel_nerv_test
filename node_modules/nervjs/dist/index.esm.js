...
Component.prototype.getState = function getState(willMount) {
    var this$1 = this;
    ...
    var state = ref.state;
    var props = ref.props;
    var _pendingCallbacks = ref._pendingCallbacks;
    ...
    if (_pendingCallbacks && willMount && _pendingCallbacks.length > 0) {
        _pendingCallbacks.forEach(function (cb, idx) {
            cb();
...
export { Children, Component, PureComponent, createElement$2 as createElement, cloneElement, render, nextTick, options, findDOMNode, isValidElement$1 as isValidElement, unmountComponentAtNode, createPortal, unstable_renderSubtreeIntoContainer, hydrate, createFactory, unstable_batchedUpdates, version, PropTypes };
